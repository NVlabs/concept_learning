...
from src.utils.data_utils import PointDataset
...
if __name__ == "__main__":
	...
	split_filename = here+"/../../data/concept_shapenet/{}/test.txt".format(args.concept)
	...
	samples = 500
	train_set = PointDataset(data_filename, label_filename, split_filename)
